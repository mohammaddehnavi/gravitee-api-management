...
public class JdbcPortalNotificationConfigRepository
    ...
    @Override
    public List<PortalNotificationConfig> findByHook(String hook) throws TechnicalException {
        LOGGER.debug("JdbcPortalNotificationConfigRepository.findByHook({})", hook);
        return findByCriteria(PortalNotificationCriteria.builder().hook(hook).build());
    }
